...
implement totype_t0intopt<> = nameof_t0intopt //nameof_t0intopt
...
implement totype_i0dntlst<> = nameof_i0dntlst //nameof_i0dntlst
implement totype_i0dntopt<> = nameof_i0dntopt //nameof_i0dntopt
...
implement totype_labs0explst<> = nameof_labs0explst //nameof_labs0explst
implement totype_sq0eid<> = nameof_sq0eid
implement totype_dq0eid<> = nameof_dq0eid
implement totype_g0exp<> = nameof_g0exp
implement totype_g0explst<> = nameof_g0explst //nameof_g0explst
implement totype_g0marg<> = nameof_g0marg
implement totype_g0marglst<> = nameof_g0marglst //nameof_g0marglst
//implement totype_g0eidlst<> = nameof_g0eidlst
implement totype_sort0<> = nameof_sort0
implement totype_sort0lst<> = nameof_sort0lst //nameof_sort0lst
implement totype_sort0opt<> = nameof_sort0opt //nameof_sort0opt
implement totype_s0arglst<> = nameof_s0arglst //nameof_s0arglst
implement totype_s0rtcon<> = nameof_s0rtcon
implement totype_s0rtconlst<> = nameof_s0rtconlst //nameof_s0rtconlst
implement totype_d0tsort<> = nameof_d0tsort
implement totype_d0tsortlst<> = nameof_d0tsortlst //nameof_d0tsortlst
implement totype_s0rtdef<> = nameof_s0rtdef
implement totype_s0arg<> = nameof_s0arg
implement totype_s0marg<> = nameof_s0marg
implement totype_s0marglst<> = nameof_s0marglst //nameof_s0marglst
implement totype_t0arg<> = nameof_t0arg
implement totype_t0arglst<> = nameof_t0arglst //nameof_t0arglst
implement totype_t0marg<> = nameof_t0marg
implement totype_t0marglst<> = nameof_t0marglst //nameof_t0marglst
implement totype_s0qua<> = nameof_s0qua
implement totype_s0qualst<> = nameof_s0qualst //nameof_s0qualst
implement totype_s0uni<> = nameof_s0uni
implement totype_s0unilst<> = nameof_s0unilst //nameof_s0unilst
implement totype_s0exp<> = nameof_s0exp
implement totype_s0explst<> = nameof_s0explst //nameof_s0explst
implement totype_s0expopt<> = nameof_s0expopt //nameof_s0expopt
...
implement totype_d0atconlst<> = nameof_d0atconlst //nameof_d0atconlst
implement totype_d0atype<> = nameof_d0atype
implement totype_d0atypelst<> = nameof_d0atypelst //nameof_d0atypelst
...
implement{} schema_t0intopt(x) = base2(x)
implement{} schema_i0dntlst(x) = base2(x)
implement{} schema_i0dntopt(x) = base2(x)
implement{} schema_g0explst(x) = base2(x)
implement{} schema_g0marglst(x) = base2(x)
implement{} schema_sort0lst(x) = base2(x)
implement{} schema_sort0opt(x) = base2(x)
implement{} schema_s0arglst(x) = base2(x)
implement{} schema_s0rtconlst(x) = base2(x)
implement{} schema_d0tsortlst(x) = base2(x)
implement{} schema_s0marglst(x) = base2(x)
implement{} schema_t0arglst(x) = base2(x)
implement{} schema_t0marglst(x) = base2(x)
implement{} schema_s0qualst(x) = base2(x)
implement{} schema_s0unilst(x) = base2(x)
implement{} schema_s0explst(x) = base2(x)
implement{} schema_s0expopt(x) = base2(x)
implement{} schema_d0atconlst(x) = base2(x)
implement{} schema_d0atypelst(x) = base2(x)
